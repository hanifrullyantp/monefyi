...
export function AnnouncementBar() {
  ...
  return (
    <AnimatePresence>
      <div className="fixed top-0 left-0 right-0 z-[60] h-10 bg-gradient-to-r from-slate-900 via-green-950 to-slate-900 border-b border-white/5 flex items-center justify-center px-4 overflow-hidden">
