...
(function () {
  window.MONEFYI_CONFIG = {
    ...
    fnVoiceTranscribe: "monefyi-voice-transcribe",
    ...
    fnAdminRevenue: "monefyi-admin-revenue",
    fnAdminUsers: "monefyi-admin-users",
    fnAdminDashboard: "monefyi-admin-dashboard",
    fnAdminAnalytics: "monefyi-admin-analytics",
    fnAdminTestLab: "monefyi-admin-test-lab",
    fnPublicConfig: "monefyi-public-config",
