...
export const LANDING_PROMISES = [
  ...
  {
    id: 'life_event_planner',
    label: 'Life Event Planner',
    landingSection: 'Growth — Milestone',
    minPlan: 'trial',
    featureFlag: null,
    entitlement: null,
    critical: false,
  ...
  {
    id: 'voice_assistant',
    label: 'Voice Financial Assistant',
    landingSection: 'Growth — Input',
    minPlan: 'trial',
    featureFlag: null,
    entitlement: null,
    critical: false,
  },
  {
    ...
    label: 'Money Personality & Personalization',
    landingSection: 'Growth — Onboarding',
    minPlan: 'trial',
    featureFlag: null,
    entitlement: null,
    critical: false,
  ...
  {
    id: 'impulse_guard',
    label: 'Impulse Purchase Guard & Wishlist',
    landingSection: 'Growth — Behavior',
    minPlan: 'trial',
    featureFlag: null,
    entitlement: null,
    critical: false,
  ...
  {
    id: 'emergency_mode',
    label: 'Emergency Financial Mode',
    landingSection: 'Growth — Safety',
    minPlan: 'trial',
    featureFlag: null,
    entitlement: null,
    critical: false,
  },
  {
    ...
    label: 'Financial Wellness Metrics',
    landingSection: 'Growth — Wellbeing',
    minPlan: 'trial',
    featureFlag: null,
    entitlement: null,
    critical: false,
  },
  {
    ...
    label: 'Smart Suggestions Engine',
    landingSection: 'Growth — Intelligence',
    minPlan: 'trial',
    featureFlag: null,
    entitlement: null,
    critical: false,
  ...
  {
    id: 'recurring_auto',
    label: 'Recurring Transactions & Reminders',
    landingSection: 'Growth — Otomasi',
    minPlan: 'trial',
    featureFlag: null,
    entitlement: null,
    critical: false,
  ...
  {
    id: 'coaching_plans',
    label: 'Personalized Coaching Plans',
    landingSection: 'Growth — Coaching',
    minPlan: 'monthly',
    featureFlag: null,
    entitlement: null,
    critical: false,
