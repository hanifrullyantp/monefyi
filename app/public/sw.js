...
const CACHE_VERSION = 'v77-product-marketing-compliance';
...
const shellPaths = [
  ...
  './js/services/budget-focus-mode.js',
  ...
  './js/services/monevisor-intervention.js',
  ...
  './js/components/budget-focus-panel.js',
  './js/components/budget-focus-picker.js',
  './js/components/upgrade-sheet.js',
  './js/components/onboarding-wizard.js',
  './js/components/onboarding-wizard-v2.js',
  './js/components/first-week-plan-card.js',
  './js/services/onboarding-plan-generator.js',
  './js/services/financial-targets.js',
  './js/services/daily-streak.js',
  './js/services/mini-win-engine.js',
  './js/services/weekly-checkin.js',
  './js/services/home-view-mode.js',
  './js/constants/language.js',
  './js/services/financial-condition.js',
  './js/services/contextual-notifications.js',
  './js/services/engagement.js',
  './js/services/balance-checker.js',
  './js/services/neraca-store.js',
  './js/services/journal-engine.js',
  './js/pages/neraca-page.js',
  './js/components/neraca-trace-modal.js',
  './js/components/neraca-category-items.js',
  './js/components/mini-win-celebration.js',
  './js/components/streak-badge.js',
  './js/components/weekly-checkin-sheet.js',
  './js/components/simple-home-view.js',
  './js/components/target-manager-modal.js',
  './js/services/first-week-plan.js',
  './js/services/daily-situation.js',
  './js/components/daily-situation-hero.js',
  './js/services/home-layout.js',
  './js/components/target-summary-card.js',
  './js/services/transaction-impact.js',
  './js/components/transaction-impact-sheet.js',
