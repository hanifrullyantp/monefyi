...
export const metadata: Metadata = {
  ...
  description: "Hitung zakat dengan mudah dan akurat. Login akun Monefyi wajib. 7 jenis zakat sesuai fatwa MUI.",
  ...
  openGraph: {
    ...
    description: "Hitung 7 jenis zakat dengan mudah dan akurat. Sesuai fatwa MUI.",
    type: "website",
    locale: "id_ID",
  },
};
