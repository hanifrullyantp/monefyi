// =====================================================
// Build neraca project from project record
// =====================================================
 ...
 * Aktiva = Saldo Kas + Piutang Klien
 * Pasiva = Dana Masuk (pemasukan) − Hutang Vendor
 */
export function buildProjectSheet(project: Project): BalanceSheet {
