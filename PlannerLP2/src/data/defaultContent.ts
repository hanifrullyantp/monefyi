...
Jika iya, saya jadwalkan survei pekan ini."`,
  ...
  features: {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Export penawaran dengan template PDF + tanda tangan gambar (logo & ttd perusahaan Anda).",
        featured: true,
      },
      {
        icon: "RefreshCw",
      ...
      },
      {
        ...
        title: "Client Portal",
        description:
          "Roadmap — klien lihat progress proyek (tersedia di paket Planner Pro mendatang).",
      },
      {
        icon: "Receipt",
        title: "Invoice & Termin",
        description:
          "Roadmap — invoice per termin & tracking pembayaran (Planner Pro mendatang).",
      },
      {
        icon: "Users",
  ...
  pricing: {
    ...
    cards: [
      {
        ...
        features: [
          ...
          { text: "Tanda Tangan di PDF (upload gambar)", included: false },
      ...
      },
      {
        ...
        whyChoose: [
          ...
          "Tanda tangan gambar di PDF + Kwitansi Pro",
        ],
        features: [
          { text: "Semua fitur Estimator Basic", included: true },
          { text: "Template PDF Premium", included: true },
          { text: "Custom Branding & Logo Full", included: true },
          { text: "Tanda Tangan Gambar di PDF", included: true },
          ...
          { text: "Kustom Pricelist Material", included: true },
        ],
        ctaText: "Ambil Pro",
        highlighted: true,
      },
    ...
    comparisonRows: [
      ...
      { group: "Advanced", feature: "Tanda Tangan di PDF", estimator: "cross", lifetime: "check" },
    ...
    miniQuestions: [
      {
        ...
        answer: "Ya. Jika sudah punya Estimator Basic, upgrade ke Pro cukup bayar selisih Rp 100.000 (Rp 199.000 − Rp 99.000) dari menu Upgrade di dalam aplikasi.",
      },
      {
  ...
  guarantee: {
    ...
    refundCtaText: "Ajukan Garansi Refund",
  },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        id: "5",
        category: "Fitur",
        question: "Apa itu tanda tangan di PDF?",
        answer:
          "Di paket Pro, Anda bisa upload gambar tanda tangan & logo perusahaan yang otomatis muncul di PDF penawaran dan kwitansi. Ini tanda tangan vendor Anda — bukan approval digital dari klien di HP mereka.",
      },
      {
        id: "6",
        category: "Fitur",
      ...
      },
      {
        ...
        answer:
          "Ya, garansi 7 hari 100% uang kembali. Ajukan via tombol di section Garansi atau halaman Kontak → Refund. Tim review 1–3 hari kerja; refund manual via Lynk ke metode pembayaran asal.",
      },
      {
        id: "15",
        category: "Teknis",
        question: "Bagaimana cara mulai setelah bayar?",
        answer:
          "1) Selesaikan pembayaran di Lynk.\n2) Cek email konfirmasi.\n3) Akun baru: klik \"Atur password & masuk\" di email, buat password, lalu login.\n4) Akun lama: login langsung dengan email & password yang sama.\n5) Klik Masuk ke dashboard Estimator, setup pricelist, buat estimasi pertama.",
      },
      {
        id: "16",
        category: "Teknis",
        question: "Apakah akses langsung setelah bayar?",
        answer:
          "Pembeli yang sudah punya akun bisa langsung masuk setelah pembayaran. Pembeli baru perlu atur password dari email terlebih dahulu (±5 menit), lalu login — entitlement aktif otomatis setelah webhook pembayaran.",
      },
    ],
  },
